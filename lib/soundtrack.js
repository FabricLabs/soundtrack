...
Soundtrack.prototype.getYoutubeVideo = function(videoID, internalCallback) {
  ...
  var youtube = new YouTube('AIzaSyBnCN68b8W5oGgBKKkM2cSQhSygnLPApEs');

  youtube.get('http://gdata.youtube.com/feeds/api/videos/'+videoID+'?v=2&alt=jsonc').on('complete', function(data, response) {
